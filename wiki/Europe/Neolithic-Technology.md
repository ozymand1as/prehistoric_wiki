...
**Copper Metallurgy (Late Neolithic/Chalcolithic):**
- Native copper hammered into beads, awls, small axes (Balkans, ~5,500 BCE)
- Smelting from malachite/azurite ores in ceramic crucibles with charcoal (Ai Bunar, Bulgaria ~5,000 BCE)
- Casting in open stone molds; later lost-wax for complex shapes

## Regional Variations

- **Central/Western Europe (LBK):** Standardized longhouses, incised pottery, flint bladelets, polished axes; rapid westward expansion (~1 km/year)
- **Mediterranean (Cardial Ware):** Impressed pottery with cockle-shell impressions; rock-shelter settlements; early maritime trade
- **Northern Europe (TRB/Funnelbeaker):** Megalithic tombs, flint mines (Spiennes, Belgium; Grimes Graves, England), early wheeled vehicles
- **Eastern Europe (Cucuteni-Trypillia):** Largest Neolithic settlements (up to 15,000 people); painted binocular vessels; two-story houses; possible proto-urbanism
- **Balkans (Vinča, Karanovo, Varna):** Earliest European copper metallurgy; Varna gold (oldest processed gold worldwide); tell settlements
- **Iberia (Los Millares, Zambujal):** Fortified settlements, tholos tombs, early copper smelting, Bell Beaker origins
- **British Isles:** Causewayed enclosures, henges, passage tombs (Newgrange, Maeshowe); Grooved Ware pottery; late Neolithic flint mining
...
2. Price, T.D. (2000). *Europe's First Farmers.* Cambridge University Press.
3. Scarre, C. (2007). *The Megalithic Monuments of Britain and Ireland.* Thames & Hudson.
4. Chapman, J. (1981). *The Vinča Culture of South-East Europe.* BAR International Series.
5. Sherratt, A. (1981). "Plough and pastoralism: aspects of the secondary products revolution." *Pattern of the Past*, 261–305.
6. Cunliffe, B. (2005). *Europe Between the Oceans: 9000 BC–AD 1000.* Yale University Press.
7. Shennan, S. (2018). *The First Farmers of Europe: An Evolutionary Perspective.* Cambridge University Press.

## Uncertainties & Research Questions

- What drove the rapid spread of LBK (~1 km/year): demic diffusion or cultural adoption?
- Function of Cucuteni-Trypillia mega-sites: urban centers, ritual gathering places, or seasonal aggregations?
- Nature of Bell Beaker phenomenon: migration, trade network, or prestige goods exchange?
- Timing and routes of megalithic tradition spread: single origin or multiple inventions?
- [[Open Questions]/[Europe-Neolithic-Open-Questions]]

**Tags:** `europe, period/neolithic, function/tool, region/europe, evidence/material, neolithic, megalithic, longhouse, polished-axes`