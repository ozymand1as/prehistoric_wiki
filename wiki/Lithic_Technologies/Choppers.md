...
**Culture(s):** Oldowan
**Time Range:** ~2.6 million years ago to ~1.7 million years ago
**Confidence:** High
...
## Function & Use
- **Primary Use:** Butchering animals and cutting meat
- **Secondary Uses:** Crushing bones, processing plant materials
- **Cultural Significance:** Represent the first deliberate modification of natural objects by hominins, marking a major cognitive and technological milestone

## Construction & Technique
Choppers are made by striking one face of a cobble with a hammerstone to create a rounded, sharp chopping edge. The technique requires selecting a suitable cobble with favorable fracture properties and applying direct percussion to produce a controlled flake removal. No preparation of the core is needed beyond selecting an appropriate stone.

## Regional Variations
- **East Africa (Olduvai Gorge):** The type region for Oldowan choppers, with the earliest well-documented assemblages
- **Kenya (Lomekwi):** Evidence of even earlier tool-making traditions predating the Oldowan
