# Lithic Technologies/Choppers-Regional

---
**Period:** Lower Paleolithic
**Region(s):** Africa, Europe, Asia
**Culture(s):** Oldowan, Abbevillian, Clactonian, Acheulean (early)
**Time Range:** ~2.6 million years ago to ~1.0 million years ago
**Confidence:** High
...
Choppers are produced by striking one face of a river cobble or large core with a hammerstone to create a sharp, rounded chopping edge. The technique relies on direct percussion, with the knapper selecting raw material based on local availability—typically quartz, basalt, or chert depending on the region. African choppers tend to use locally available volcanic and sedimentary stones, while European choppers frequently employ flint and quartzite. Asian choppers show preference for quartz and sandstone in some regions. The knapping technique involves a single or few hard-hammer strikes to remove flakes from one face, creating an asymmetric edge suitable for chopping. No formal core preparation is required, though the selection of cobbles with favorable fracture properties is essential. Regional differences in technique reflect the availability of suitable raw material and the specific functional demands of local environments.
...
- **Asia (Zhoukoudian and Sangiran Traditions):** Asian choppers are documented at Zhoukoudian (China) and Sangiran (Java), with traditions showing both shared characteristics with African Oldowan tools and unique regional features. Zhoukoudian choppers are predominantly made from quartz and sandstone, reflecting the local raw material availability in the limestone karst regions of China. Sangiran choppers in Java are associated with early Homo erectus and show adaptations to the tropical environments of Southeast Asia. Asian chopper traditions generally exhibit simpler flaking patterns compared to African assemblages, with a greater reliance on locally available quartz and a less systematic approach to raw material selection. The transition to bifacial technologies in Asia occurred later than in Africa and Europe, with some regions maintaining chopper traditions well into the Middle Pleistocene.
...
3. Clark, J.D. (1969). "The Lower Palaeolithic Cultures of Southern Asia and Their Relation to those of Africa and Europe." *World Archaeology*, 1(2), 167–186.
4. Bordes, F. (1961). "Typologie du Paléolithique ancien et moyen." *Bulletin de la Société Préhistorique Française*, 58(3–4), 136–144.
...
- The extent to which raw material availability alone explains morphological differences between regional choppers
- The timeline of the chopper-to-handaxe transition in each region and whether it was driven by cognitive, social, or environmental factors
