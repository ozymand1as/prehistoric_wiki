...
---
**Period:** Lower Paleolithic through Neolithic
**Region(s):** Africa, Europe, Asia
**Culture(s):** Acheulean, Neolithic cultures
**Time Range:** ~1.76 million years ago – ~4,000 years ago
**Confidence:** High
...
Acheulean hand axes were produced by bifacial knapping, striking stone cores on both faces to thin and shape the implement. Neolithic ground stone axes were made by grinding and polishing stone slabs (typically basalt, jade, or flint) to achieve a sharp edge, while axe hafting involved securing the stone head to a wooden handle using cordage, resin, or leather bindings. The development of hafting required advanced understanding of materials and adhesive properties.
