...
- **Lower Paleolithic (~3.3 Ma – 300 ka):** Earliest stone tool production, including Oldowan choppers and Acheulean handaxes. Key sites include Lomekwi (Kenya, ~3.3 Ma) and Olduvai Gorge (Tanzania, ~1.8 Ma). [2]
...
- **Primary Use:** Utility tasks including cutting, scraping, piercing, and grinding [3]
...
- **Percussion flaking:** Striking the core with a hammerstone or antler bat to detach flakes [4]
...
- **East Africa:** Oldowan and Acheulean traditions at Olduvai Gorge and Lomekwi; earliest known stone tool production [5]
...
7. Semaw, S. et al. (2020). *Early Stone Age tools from Lomekwi*. Nature, 557(7705), 1–5.
