...
- **Hygiene:** Chewing sticks (miswak from Salvadora persica), abrasive powders (pumice, charcoal, crushed bone), and toothpicks (wood, bone, quill)

## Regional Variations

- **South Asia (Mehrgarh):** Earliest known drilling (9,000 BP); precise conical holes in molars suggesting therapeutic intent
- **Europe (Neolithic Slovenia):** Beeswax filling in a left canine (~6500 BCE); earliest direct evidence of therapeutic filling
- **Mesoamerica (Maya):** Decorative inlays of jade, turquoise, pyrite, and hematite drilled into anterior teeth; filing into points or notches; predominantly elite practice
- **Africa (Various):** Tooth ablation (removal of incisors) in East and Southern Africa for initiation rites; filing in West Africa; chewing stick hygiene widespread
- **Oceania (Aboriginal Australia):** Tooth evulsion (knocking out incisors) in initiation ceremonies; charcoal and ash for cleaning
- **Ancient Near East (Egypt, Mesopotamia):** Medical papyri document treatments for "tooth worms" (caries); gold wire splints for loose teeth; recipes for mouthwashes and pain relief
...
1. Coppe, C. et al. (2006). "Early Neolithic dentistry: A tooth from Mehrgarh, Pakistan." *Nature*, 440(7085), 755–756.
2. Bernardini, F. et al. (2012). "Beeswax as dental filling on a Neolithic human tooth." *PLoS ONE*, 7(9), e44904.
3. Schlotzhauer, H. (2008). "Dental care in ancient Egypt." *Journal of the History of Dentistry*, 56(1), 11–16.
4. Scott, G.R. & Turner, C.G. (1997). *The Anthropology of Modern Human Teeth: Dental Morphology and Its Variation in Recent Human Populations.* Cambridge University Press.
5. Guatelli-Steinberg, D. (2016). *What Teeth Reveal About Human Evolution.* Cambridge University Press.

## Uncertainties & Research Questions

- Were Mehrgarh drillings therapeutic or ritualistic? Survival rates and infection evidence remain unclear.
- How widespread was beeswax filling in Neolithic Europe? Single find limits generalization.
- What plant-based anesthetics/analgesics were used in prehistoric dental procedures?
- [[Open Questions]/[Dental-Care-Open-Questions]]

**Tags:** `medicine, dental-care, period/prehistoric, region/global, evidence/material, evidence/ethnographic, function/medical`